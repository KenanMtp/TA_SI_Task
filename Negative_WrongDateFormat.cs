...
namespace Negative_WrongDateFormat
{
    ...
    public class Tests<TWebDriver> where TWebDriver : IWebDriver, new()
    {
        ...
        public void NunitSeleniumTest()
        {
            ...
            //Used unallowed format of DATE of birth +123456789, format of DATE of birth should be: yyyy-MM-dd
            //and not shorter than 5 chars
            _driver.FindElement(By.Id("birthdate")).SendKeys("+98765");
            _driver.FindElement(By.Id("submit")).Click();
            wait.Until(ExpectedConditions.UrlContains("/addContact"));
            Thread.Sleep(2500);
            ...
            string expected_error_message = "Birthdate is invalid";
